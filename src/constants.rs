...
pub const DIR_DEV_HUGEPAGES: &str = "/dev/hugepages";
pub const DIR_DEV_MQUEUE: &str = "/dev/mqueue";
...
pub const ENV_PATH: &str = "/usr/local/bin:/usr/local/sbin:/usr/bin:/usr/sbin:/bin:/sbin";

pub const SSL_CERT_FILE: &str = "amazon.pem";

pub const USER_NAME_ROOT: &str = "root";
pub const USER_NAME_CHRONY: &str = "cb-chrony";
pub const USER_NAME_SSH: &str = "cb-ssh";
